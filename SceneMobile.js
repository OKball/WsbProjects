...
class SceneMobile extends Phaser.Scene {
    ...
    create () {
        ...
        this.point = 0;
        this.background = this.add.image(win_ingame_width/2, win_ingame_height/2, 'background');
        this.basket = this.add.image(win_ingame_width/2, (win_ingame_height/2) - 100, 'basket');
